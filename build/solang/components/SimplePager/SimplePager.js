...
const SimplePager = ({ appId, alias, next = 'Next', prev = 'Previous' }) => {
    ...
    return (_jsxs("div", Object.assign({ className: CLASS }, { children: [!isStart && _jsx("button", Object.assign({ className: `${CLASS}__prev`, onClick: prevHandler }, { children: prev }), void 0), !isEnd && _jsx("button", Object.assign({ className: `${CLASS}__next`, onClick: nextHandler }, { children: next }), void 0)] }), void 0));
};
