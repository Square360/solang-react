...
const SortSelect = ({ appId, alias }) => {
    ...
    return (_jsx("div", Object.assign({ className: CLASS }, { children: _jsx("select", Object.assign({ className: `${CLASS}__input`, onChange: updateHandler }, { children: filterState.config.options.map(item => (_jsx("option", Object.assign({ value: item.value, className: `${CLASS}__input` }, { children: item.label }), item.value))) }), void 0) }), void 0));
};
